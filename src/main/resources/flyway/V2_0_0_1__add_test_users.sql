...
insert into users(id,uid,unique_name,email,password,salt) select 101,101,'zhangzuliang','zhangzuliang@ipetty.net','0e9a23404e086821e827bc647c7ecd73339e5101','45a37e962bd54fdf' from users where not exists (select * from users where email='service@ipetty.net');
insert into users(id,uid,unique_name,email,password,salt) select 102,102,'xiaojinghai','xiaojinghai@ipetty.net','9bd68c251be901430d6b3bd111ac8cba13b008ce','7a2a9b7682d478ef' from users where not exists (select * from users where email='service@ipetty.net');
insert into users(id,uid,unique_name,email,password,salt) select 103,103,'kongchun','kongchun@ipetty.net','95f1d877c00ec440163c236e32f68da74c65e594','b37e309c16febafc' from users where not exists (select * from users where email='service@ipetty.net');
insert into users(id,uid,unique_name,email,password,salt) select 104,104,'luocanfeng','luocanfeng@ipetty.net','f62de3b1c5829bac32efae54551db05dbddf67f9','40363981c8dac616' from users where not exists (select * from users where email='service@ipetty.net');
